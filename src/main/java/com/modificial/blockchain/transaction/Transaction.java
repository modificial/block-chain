package com.modificial.blockchain.transaction;

import com.modificial.blockchain.block.Blockchain;
import com.modificial.blockchain.util.SerializeUtils;
...
import com.modificial.blockchain.util.BtcAddressUtils;
...
public class Transaction {
    ...
    public static void main(String[] args) {
        ...
        str = String.format("Reward to '%s'", "shashilei");
